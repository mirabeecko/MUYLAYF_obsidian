...
var mu = (e, t8) => () => (e && (t8 = e(e = 0)), t8);
var Me = (e, t8) => () => (t8 || e((t8 = { exports: {} }).exports, t8), t8.exports);
var We = (e, t8) => {
  for (var r in t8) $e(e, r, { get: t8[r], enumerable: true });
};
var nr = (e, t8, r, n) => {
  if (t8 && typeof t8 == "object" || typeof t8 == "function") for (let o of Fu(t8)) !du.call(e, o) && o !== r && $e(e, o, { get: () => t8[o], enumerable: !(n = fu(t8, o)) || n.enumerable });
  return e;
};
var he = (e, t8, r) => (r = e != null ? lu(pu(e)) : {}, nr(t8 || !e || !e.__esModule ? $e(r, "default", { value: e, enumerable: true }) : r, e));
var Eu = (e) => nr($e({}, "__esModule", { value: true }), e);
var Cu = (e, t8, r) => {
...
var ce = (e, t8, r) => (Cu(e, t8, "access private method"), r);
var or = Me((gt2) => {
  "use strict";
...
var Fn = {};
We(Fn, { default: () => uo, shouldHighlight: () => no });
var no;
var uo;
var pn = mu(() => {
  no = () => false, uo = String;
...
var yn = Me((Ft2) => {
  ...
  Ft2.default = ao2;
  var dn2 = (pn(), Eu(Fn)), mn2 = oo2(Pe(), true);
  function hn2(e) {
  ...
  function io2(e) {
    if (e) {
      var t8;
      return (t8 = jt2) != null || (jt2 = new mn2.default.constructor({ enabled: true, level: 1 })), jt2;
    }
    return mn2.default;
  }
  var En2 = false;
...
var tr = {};
We(tr, { __debug: () => ri, check: () => ei, doc: () => er, format: () => cu, formatWithCursor: () => au, getSupportInfo: () => ti, util: () => Qt, version: () => Du });
var hu = (e, t8, r, n) => {
...
var O = "label";
var b = "break-parent";
var Ue = /* @__PURE__ */ new Set([W, T, S, v, _, k, x, P, L, I, A, O, b]);
function xu(e) {
...
var U = xu;
var ku = (e) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(e);
function bu(e) {
...
var ze = Dr;
function ie(e) {
  return z(e), { type: T, contents: e };
}
function oe(e, t8) {
  return z(t8), { type: S, contents: t8, n: e };
}
function At(e, t8 = {}) {
...
function fr(e, t8) {
  return At(e[0], { ...t8, expandedStates: e });
}
function Ge(e) {
  return ze(e), { type: k, parts: e };
}
function Fr(e, t8 = "", r = {}) {
  return z(e), t8 !== "" && z(t8), { type: x, breakContents: e, flatContents: t8, groupId: r.groupId };
}
function pr(e, t8) {
...
var le = { type: b };
var mr = { type: v };
var _e = { type: A, hard: true };
var Bt = { type: A, hard: true, literal: true };
var Ke = { type: A };
var Er = { type: A, soft: true };
var G = [_e, le];
var He = [Bt, le];
var xe = { type: W };
function ke(e, t8) {
...
function qe(e, t8, r) {
  ...
  let n = e;
  if (t8 > 0) {
    for (let o = 0; o < Math.floor(t8 / r); ++o) n = ie(n);
...
function Tu(e) {
  ...
  for (let r of e) {
    ...
    n <= 31 || n >= 127 && n <= 159 || n >= 768 && n <= 879 || (t8 += _r(n) ? 1 : 2);
  }
  return t8;
}
var we = Tu;
...
function Su(e) {
  if (e.type === _ && e.break || e.type === A && e.hard || e.type === b) return true;
}
function wr(e) {
  return Je(e, Su, false);
}
function xr(e) {
  if (e.length > 0) {
    let t8 = y(false, e, -1);
...
function kr(e) {
  for (e = [...e]; e.length >= 2 && y(false, e, -2).type === A && y(false, e, -1).type === b; ) e.length -= 2;
  if (e.length > 0) {
...
function Lu(e) {
  return Ne(e, (t8) => Pu(t8));
}
function Tr(e, t8 = He) {
  return Ne(e, (r) => typeof r == "string" ? ke(t8, r.split(`
`)) : r);
}
function Iu(e) {
...
function Ru(e, t8) {
  return xt(e, { type: "indent" }, t8);
}
function Yu(e, t8, r) {
  return t8 === Number.NEGATIVE_INFINITY ? e.root || vr() : t8 < 0 ? xt(e, { type: "dedent" }, r) : t8 ? t8.type === "root" ? { ...e, root: e } : xt(e, { type: typeof t8 == "string" ? "stringAlign" : "numberAlign", n: t8 }, r) : e;
}
function xt(e, t8, r) {
...
function kt(e) {
  ...
  if (t8 > 0 || r > 0) for (e.length = n + 1; r-- > 0; ) e.push(Te);
  return t8;
}
...
function fe(e, t8) {
  let r = {}, n = t8.printWidth, o = be(t8.endOfLine), u = 0, i = [{ ind: vr(), mode: R, doc: e }], s = [], D = false, a = [], c = 0;
  for (Or(e); i.length > 0; ) {
...
`, o) : l;
      ...
      case _:
        switch (p) {
          ...
          case R: {
            D = false;
            let F2 = { ind: f2, mode: K, doc: l.contents }, m = n - u, E2 = a.length > 0;
            if (!l.break && Qe(F2, i, m, E2, r)) i.push(F2);
            else if (l.expandedStates) {
              let C = y(false, l.expandedStates, -1);
              if (l.break) {
                i.push({ ind: f2, mode: R, doc: C });
                break;
            ...
            } else i.push({ ind: f2, mode: R, doc: l.contents });
            break;
          }
        }
      ...
      case k: {
        ...
        if (m.length === 0) break;
        let [E2, C] = m, g = { ind: f2, mode: K, doc: E2 }, h2 = { ind: f2, mode: R, doc: E2 }, B = Qe(g, [], F2, a.length > 0, r, true);
        if (m.length === 1) {
          B ? i.push(g) : i.push(h2);
          break;
        }
        let Z = { ind: f2, mode: K, doc: C }, $ = { ind: f2, mode: R, doc: C };
        if (m.length === 2) {
          B ? i.push(Z, g) : i.push($, h2);
          break;
        }
        m.splice(0, 2);
        let Q2 = { ind: f2, mode: p, doc: Ge(m) }, rr2 = m[0];
        Qe({ ind: f2, mode: K, doc: [E2, C, rr2] }, [], F2, a.length > 0, r, true) ? i.push(Q2, Z, g) : B ? i.push(Q2, $, g) : i.push(Q2, $, h2);
        break;
      }
      case x:
      case P: {
      ...
      case L:
        ...
        break;
      case I:
        a.length > 0 && i.push({ ind: f2, mode: p, doc: _e });
        break;
      case A:
        switch (p) {
          case K:
          ...
          case R:
            ...
            l.literal ? f2.root ? (s.push(o, f2.root.value), u = f2.root.length) : (s.push(o), u = 0) : (u -= kt(s), s.push(o + f2.value), u = f2.length);
            break;
        }
        break;
      case O:
  ...
  let d = s.indexOf(Te);
  if (d !== -1) {
    let f2 = s.indexOf(Te, d + 1), p = s.slice(0, d).join(""), l = s.slice(d + 1, f2).join(""), F2 = s.slice(f2 + 1).join("");
...
function J(e) {
  ...
  return e.type === x ? { ...e, breakContents: J(e.breakContents), flatContents: J(e.flatContents) } : e.type === _ ? { ...e, contents: J(e.contents), expandedStates: (t8 = e.expandedStates) == null ? void 0 : t8.map(J) } : e.type === k ? { type: "fill", parts: e.parts.map(J) } : e.contents ? { ...e, contents: J(e.contents) } : e;
}
function Pr(e) {
...
function et({ plugins: e = [], showDeprecated: t8 = false } = {}) {
  let r = e.flatMap((o) => {
    var _a2;
    return (_a2 = o.languages) != null ? _a2 : [];
  }), n = [];
...
function Wu(e, t8) {
  var _a2, _b;
  if (t8) return (_b = (_a2 = e.find(({ name: r }) => r.toLowerCase() === t8)) != null ? _a2 : e.find(({ aliases: r }) => r == null ? void 0 : r.includes(t8))) != null ? _b : e.find(({ extensions: r }) => r == null ? void 0 : r.includes(`.${t8}`));
}
function Uu(e, t8) {
  var _a2, _b, _c;
  ...
  }), n = (_c = (_b = (_a2 = Wu(r, t8.language)) != null ? _a2 : Ir(r, t8.physicalFile)) != null ? _b : Ir(r, t8.file)) != null ? _c : (t8.physicalFile, void 0);
  return n == null ? void 0 : n.parsers[0];
}
var Rr = Uu;
var te = { key: (e) => /^[$_a-zA-Z][$_a-zA-Z0-9]*$/.test(e) ? e : JSON.stringify(e), value(e) {
  if (e === null || typeof e != "object") return JSON.stringify(e);
  if (Array.isArray(e)) return `[${e.map((r) => te.value(r)).join(", ")}]`;
  let t8 = Object.keys(e);
  return t8.length === 0 ? "{}" : `{ ${t8.map((r) => `${te.key(r)}: ${te.value(e[r])}`).join(", ")} }`;
}, pair: ({ key: e, value: t8 }) => te.value({ [e]: t8 }) };
var bt = he(Pe(), 1);
var Vr = (e, t8, { descriptor: r }) => {
  let n = [`${bt.default.yellow(typeof e == "string" ? r.key(e) : r.pair(e))} is deprecated`];
  return t8 && n.push(`we now treat it as ${bt.default.blue(typeof t8 == "string" ? r.key(t8) : r.pair(t8))}`), n.join("; ") + ".";
};
var se = he(Pe(), 1);
var tt = Symbol.for("vnopts.VALUE_NOT_EXIST");
var pe = Symbol.for("vnopts.VALUE_UNCHANGED");
var $r = " ".repeat(2);
var Wr = (e, t8, r) => {
  let { text: n, list: o } = r.normalizeExpectedResult(r.schemas[e].expected(r)), u = [];
  return n && u.push(Mr(e, t8, n, r.descriptor)), o && u.push([Mr(e, t8, o.title, r.descriptor)].concat(o.values.map((i) => Ur(i, r.loggerPrintWidth))).join(`
`)), zr(u, r.loggerPrintWidth);
};
function Mr(e, t8, r, n) {
  return [`Invalid ${se.default.red(n.key(e))} value.`, `Expected ${se.default.blue(r)},`, `but received ${t8 === tt ? se.default.gray("nothing") : se.default.red(n.value(t8))}.`].join(" ");
}
function Ur({ text: e, list: t8 }, r) {
  let n = [];
  return e && n.push(`- ${se.default.blue(e)}`), t8 && n.push([`- ${se.default.blue(t8.title)}:`].concat(t8.values.map((o) => Ur(o, r - $r.length).replace(/^|\n/g, `$&${$r}`))).join(`
`)), zr(n, r);
}
function zr(e, t8) {
...
function Ot(e, t8) {
  ...
  for (; d < o; ) for (i = t8.charCodeAt(u + d), D = d++, s = d, c = 0; c < n; c++) a = i === Gr[c] ? D : D + 1, D = wt[c], s = wt[c] = D > s ? a > s ? s + 1 : a : a > D ? D + 1 : a;
  return s;
}
var rt = (e, t8, { descriptor: r, logger: n, schemas: o }) => {
  let u = [`Ignored unknown option ${Nt.default.yellow(r.pair({ key: e, value: t8 }))}.`], i = Object.keys(o).sort().find((s) => Ot(e, s) < 3);
  i && u.push(`Did you mean ${Nt.default.blue(r.key(i))}?`), n.warn(u.join(" "));
};
var zu = ["default", "expected", "validate", "deprecated", "forward", "redirect", "overlap", "preprocess", "postprocess"];
function Gu(e, t8) {
...
function St(e) {
  ...
  return Hu((t8 || r) !== void 0, "Unexpected `expected` result, there should be at least one field."), r ? { text: t8, list: { title: r.title, values: r.values.map(St) } } : { text: t8 };
}
function vt(e, t8) {
  return e === true ? true : e === false ? { value: t8 } : e;
}
function Pt(e, t8, r = false) {
...
function st(e, t8) {
  return e === void 0 ? [] : Array.isArray(e) ? e.map((r) => Hr(r, t8)) : [Hr(e, t8)];
}
function Lt(e, t8) {
  let r = st(typeof e == "object" && "redirect" in e ? e.redirect : e, t8);
...
var Dt = class extends w {
  constructor(t8) {
    super(t8), this._choices = Jr(t8.choices.map((r) => r && typeof r == "object" ? r : { value: r }), "value");
  }
  expected({ descriptor: t8 }) {
    let r = Array.from(this._choices.keys()).map((i) => this._choices.get(i)).filter(({ hidden: i }) => !i).map((i) => i.value).sort(en).map(t8.value), n = r.slice(0, -2), o = r.slice(-2);
...
var ct = class extends at {
  ...
  validate(t8, r) {
    return r.normalizeValidateResult(super.validate(t8, r), t8) === true && Qr(t8);
  }
};
...
var lt = class {
  constructor(t8, r) {
    let { logger: n = console, loggerPrintWidth: o = 80, descriptor: u = rn, unknown: i = nn, invalid: s = un, deprecated: D = on, missing: a = () => false, required: c = () => false, preprocess: d = (p) => p, postprocess: f2 = () => pe } = r || {};
    this._utils = { descriptor: u, logger: n || { warn: () => {
    } }, loggerPrintWidth: o, schemas: qr(t8, "name"), normalizeDefaultResult: Tt, normalizeExpectedResult: St, normalizeDeprecatedResult: Pt, normalizeForwardResult: st, normalizeRedirectResult: Lt, normalizeValidateResult: vt }, this._unknownHandler = i, this._invalidHandler = tn(s), this._deprecatedHandler = D, this._identifyMissing = (p, l) => !(p in l) || a(p, l), this._identifyRequired = c, this._preprocess = d, this._postprocess = f2, this.cleanHistory();
  }
  cleanHistory() {
  ...
  _applyNormalization(t8, r) {
    ...
    for (let i of o) {
      ...
      let a = ({ from: p, to: l }) => {
        ...
        let F2 = Pt(s.deprecated(p, this._utils), D, true);
      ...
      let f2 = Lt(s.redirect(D, this._utils), D);
  ...
  _applyRequiredCheck(t8) {
    for (let r of Object.keys(this._utils.schemas)) if (this._identifyMissing(r, t8) && this._identifyRequired(r)) throw this._invalidHandler(r, tt, this._utils);
  }
  _partitionOptionKeys(t8) {
    let [r, n] = Zr(Object.keys(t8).filter((o) => !this._identifyMissing(o, t8)), (o) => o in this._utils.schemas);
    return { knownKeys: r, unknownKeys: n };
  }
  _applyValidation(t8, r, n) {
    let o = vt(n.validate(t8, this._utils), t8);
...
function Xu(e, { isCLI: t8, FlagSchema: r }) {
  let n = [];
  t8 && n.push(ut.create({ name: "_" }));
  for (let o of e) n.push(Zu(o, { isCLI: t8, optionInfos: e, FlagSchema: r })), o.alias && t8 && n.push(nt.create({ name: o.alias, sourceName: o.name }));
  return n;
}
function Zu(e, { isCLI: t8, optionInfos: r, FlagSchema: n }) {
  ...
  switch (e.type) {
    case "int":
      i = ct, t8 && (u.preprocess = Number);
      break;
    case "string":
      i = Le;
      break;
    case "choice":
      i = Dt, u.choices = e.choices.map((D) => D != null && D.redirect ? { ...D, redirect: { to: { key: e.name, value: D.redirect } } } : D);
      break;
    case "boolean":
      i = it;
      break;
  ...
  return e.array ? ot.create({ ...t8 ? { preprocess: (D) => Array.isArray(D) ? D : [D] } : {}, ...s, valueSchema: i.create(u) }) : i.create({ ...u, ...s });
}
var sn = Ju;
function Rt(e, t8) {
...
function ft({ plugins: e, parser: t8 }) {
  let r = Rt(e, t8);
  return Yt(r, t8);
}
function Yt(e, t8) {
...
var cn = { astFormat: "estree", printer: {}, originalText: void 0, locStart: null, locEnd: null };
async function Qu(e, t8 = {}) {
  var d;
  let r = { ...e };
  if (!r.parser) if (r.filepath) {
    if (r.parser = Rr(r, { physicalFile: r.filepath }), !r.parser) throw new ve(`No parser could be inferred for file "${r.filepath}".`);
  } else throw new ve("No parser and no file path given, couldn't infer a parser.");
  let n = et({ plugins: e.plugins, showDeprecated: true }).options, o = { ...cn, ...Object.fromEntries(n.filter((f2) => f2.default !== void 0).map((f2) => [f2.name, f2.default])) }, u = Rt(r.plugins, r.parser), i = await Yt(u, r.parser);
  ...
  return r.parser === "json" && (r.trailingComma = "none"), sn(r, n, { passThrough: Object.keys(cn), ...t8 });
}
var re = Qu;
var ln = /* @__PURE__ */ new Set(["tokens", "comments", "parent", "enclosingNode", "precedingNode", "followingNode"]);
var eo = (e) => Object.keys(e).filter((t8) => !ln.has(t8));
function to(e) {
  return e ? (t8) => e(t8, ln) : eo;
}
var H = to;
function ro(e, t8) {
  var _a2;
  ...
  if (!r) return e;
  let o = H(n), u = (_a2 = r.ignoredProperties) != null ? _a2 : /* @__PURE__ */ new Set();
  return i(e);
  function i(s, D) {
    ...
    let d = r(s, a, D);
    if (d !== null) return d != null ? d : a;
  }
}
var fn = ro;
var An = he(yn(), 1);
async function co(e, t8) {
  let r = await ft(t8), n = r.preprocess ? r.preprocess(e, t8) : e;
  t8.originalText = n;
  let o;
  try {
...
function lo(e, t8) {
  let { loc: r } = e;
  if (r) {
    let n = (0, An.codeFrameColumns)(t8, r, { highlightCode: true });
    throw e.message += `
` + n, e.codeFrame = n, e;
  }
  throw e;
...
var Vt = class {
  ...
  get key() {
    ...
    return (_a2 = y(false, t8, r === null ? -2 : -4)) != null ? _a2 : null;
  }
  get index() {
  ...
  get ancestors() {
    return [...ce(this, de, pt).call(this)];
  }
  getName() {
  ...
  getNode(t8 = 0) {
    let r = ce(this, Ie, $t).call(this, t8);
  ...
  findAncestor(t8) {
    for (let r of ce(this, de, pt).call(this)) if (t8(r)) return r;
  }
  hasAncestor(t8) {
    for (let r of ce(this, de, pt).call(this)) if (t8(r)) return true;
    return false;
  }
};
Ie = /* @__PURE__ */ new WeakSet(), $t = function(t8) {
  let { stack: r } = this;
  for (let n = r.length - 1; n >= 0; n -= 2) if (!Array.isArray(r[n]) && --t8 < 0) return n;
  return -1;
}, de = /* @__PURE__ */ new WeakSet(), pt = function* () {
  let { stack: t8 } = this;
...
var Y = fo;
function Fo(e, t8, r = {}) {
  let n = N(e, r.backwards ? t8 - 1 : t8, r), o = Y(e, n, r);
  return n !== o;
}
var V = Fo;
function po(e) {
...
var kn = mo;
function* Wt(e, t8) {
  let { getVisitorKeys: r, filter: n = () => true } = t8, o = (u) => kn(u) && n(u);
  for (let u of r(e)) {
    let i = e[u];
...
function* bn(e, t8) {
  ...
  for (let n = 0; n < r.length; n++) {
    let o = r[n];
    for (let u of Wt(o, t8)) yield u, r.push(u);
  }
}
function Eo(e) {
...
function Ut(e, t8) {
  var _a2;
  ((_a2 = e.comments) != null ? _a2 : e.comments = []).push(t8), t8.printed = false, t8.nodeDescription = Eo(e);
}
function ne(e, t8) {
  t8.leading = true, t8.trailing = false, Ut(e, t8);
}
function X(e, t8, r) {
  t8.leading = false, t8.trailing = false, r && (t8.marker = r), Ut(e, t8);
}
function ue(e, t8) {
  t8.leading = false, t8.trailing = true, Ut(e, t8);
}
...
function Et(e, t8) {
  ...
  if (!n) return [];
  let s = ((_a2 = r == null ? void 0 : r(e, t8)) != null ? _a2 : [...Wt(e, { getVisitorKeys: H(o) })]).flatMap((D) => n(D) ? [D] : Et(D, t8));
  return s.sort((D, a) => u(D) - u(a) || i(D) - i(a)), zt.set(e, s), s;
}
function On(e, t8, r, n) {
  let { locStart: o, locEnd: u } = r, i = o(t8), s = u(t8), D = Et(e, r), a, c, d = 0, f2 = D.length;
  for (; d < f2; ) {
    let p = d + f2 >> 1, l = D[p], F2 = o(l), m = u(l);
    if (F2 <= i && s <= m) return On(l, t8, r, l);
    if (m <= i) {
      a = l, d = p + 1;
      continue;
    }
...
function Nn(e, t8) {
  let { comments: r } = e;
  if (delete e.comments, !Mt(r) || !t8.printer.canAttachComment) return;
  let n = [], { locStart: o, locEnd: u, printer: { experimentalFeatures: { avoidAstMutation: i = false } = {}, handleComments: s = {} }, originalText: D } = t8, { ownLine: a = Gt, endOfLine: c = Gt, remaining: d = Gt } = s, f2 = r.map((p, l) => ({ ...On(e, p, t8), comment: p, text: D, options: t8, ast: e, isLastComment: r.length - 1 === l }));
  for (let [p, l] of f2.entries()) {
    ...
    let $;
    if (i ? $ = [l] : (F2.enclosingNode = E2, F2.precedingNode = m, F2.followingNode = C, $ = [F2, g, h2, B, Z]), Co(g, h2, f2, p)) F2.placement = "ownLine", a(...$) || (C ? ne(C, F2) : m ? ue(m, F2) : E2 ? X(E2, F2) : X(B, F2));
    else if (ho(g, h2, f2, p)) F2.placement = "endOfLine", c(...$) || (m ? ue(m, F2) : C ? ne(C, F2) : E2 ? X(E2, F2) : X(B, F2));
    else if (F2.placement = "remaining", !d(...$)) if (m && C) {
      let Q2 = n.length;
      Q2 > 0 && n[Q2 - 1].followingNode !== C && wn(n, h2), n.push(l);
    } else m ? ue(m, F2) : C ? ne(C, F2) : E2 ? X(E2, F2) : X(B, F2);
  }
  if (wn(n, t8), !i) for (let p of r) delete p.precedingNode, delete p.enclosingNode, delete p.followingNode;
}
var Tn = (e) => !/[\S\n\u2028\u2029]/.test(e);
function Co(e, t8, r, n) {
...
function wn(e, t8) {
  ...
  for (i = r; i > 0; --i) {
    ...
    if ((_a2 = (D = (s = t8.printer).isGap) == null ? void 0 : D.call(s, f2, t8)) != null ? _a2 : /^[\s(]*$/.test(f2)) u = t8.locStart(a);
    else break;
  }
...
function yo(e, t8) {
  var c;
  let r = e.node, n = [Sn(e, t8)], { printer: o, originalText: u, locStart: i, locEnd: s } = t8;
...
function Ao(e, t8, r) {
  var a;
  let n = e.node, o = Sn(e, t8), { printer: u, originalText: i, locStart: s } = t8, D = (a = u.isBlockComment) == null ? void 0 : a.call(u, n);
  if (r != null && r.hasLineSuffix && !(r != null && r.isBlock) || V(i, s(n), { backwards: true })) {
    let c = Ye(i, s(n));
    return { doc: Be([G, c ? G : "", o]), isBlock: D, hasLineSuffix: true };
  }
  return !D || r != null && r.hasLineSuffix ? { doc: [Be([" ", o]), le], isBlock: D, hasLineSuffix: true } : { doc: [" ", o], isBlock: D, hasLineSuffix: false };
}
function Bo(e, t8) {
  let r = e.node;
  if (!r) return {};
  ...
  return e.each(() => {
    ...
    a ? u.push(yo(e, t8)) : c && (s = Ao(e, t8, s), i.push(s.doc));
...
async function Ln(e, t8, r, n, o) {
  ...
  let a = H((_a2 = i.getVisitorKeys) != null ? _a2 : D), c = [];
  p();
  let d = e.stack;
...
async function _o(e, t8, r, n) {
  let o = await re({ ...r, ...t8, parentParser: r.parser, originalText: e }, { passThrough: true }), { ast: u } = await De(e, o), i = await n(u, o);
  return Xe(i);
}
function xo(e) {
  return () => {
...
async function je(e, t8) {
  ({ ast: e } = await Ht(e, t8));
  let r = /* @__PURE__ */ new Map(), n = new Bn(e), o = In(t8), u = /* @__PURE__ */ new Map();
  await Ln(n, s, t8, je, u);
...
function Yn(e, t8, r, n, o) {
  ...
  return (D = i.hasPrettierIgnore) != null && D.call(i, e) ? s = Rn(e, t8) : o.has(u) ? s = o.get(u) : s = i.print(e, t8, r, n), u === t8.cursorNode && (s = Ze(s, (a) => [xe, a, xe])), i.printComment && (!i.willPrintOwnComments || !i.willPrintOwnComments(e, t8)) && (s = vn(e, s, t8)), s;
}
async function Ht(e, t8) {
  var _a2, _b;
  let r = (_a2 = e.comments) != null ? _a2 : [];
  t8[Symbol.for("comments")] = r, t8[Symbol.for("tokens")] = (_b = e.tokens) != null ? _b : [], t8[Symbol.for("printedComments")] = /* @__PURE__ */ new Set(), Nn(e, t8);
...
function Oo(e, t8, { locStart: r, locEnd: n }) {
  ...
  let i = r(e.node);
  for (let D of jn(t8.parentNodes)) if (r(D) >= i) u = D;
  else break;
  let s = n(t8.node);
...
var To = /* @__PURE__ */ new Set(["OperationDefinition", "FragmentDefinition", "VariableDefinition", "TypeExtensionDefinition", "ObjectTypeDefinition", "FieldDefinition", "DirectiveDefinition", "EnumTypeDefinition", "EnumValueDefinition", "InputValueDefinition", "InputObjectTypeDefinition", "SchemaDefinition", "OperationTypeDefinition", "InterfaceTypeDefinition", "UnionTypeDefinition", "ScalarTypeDefinition"]);
function Vn(e, t8, r) {
  if (!t8) return false;
  switch (e.parser) {
    case "flow":
...
function Mn(e, t8, r) {
  ...
  let a = qt(r, n, t8, (p, l) => Vn(t8, p, l), [], "rangeStart"), c = D ? a : qt(r, o, t8, (p) => Vn(t8, p), [], "rangeEnd");
...
function So(e, t8) {
  ...
  for (let D of bn(e, { getVisitorKeys: u, filter: i })) s = D;
  return s;
}
var Wn = So;
var Hn = "\uFEFF";
var Un = Symbol("cursor");
async function qn(e, t8, r = 0) {
  if (!e || e.trim().length === 0) return { formatted: "", cursorOffset: -1, comments: [] };
  let { ast: n, text: o } = await De(e, t8);
  t8.cursorOffset >= 0 && (t8.cursorNode = Wn(n, t8));
  let u = await je(n, t8, r);
  r > 0 && (u = qe([G, u], r, t8.tabWidth));
  let i = fe(u, t8);
  if (r > 0) {
    let D = i.formatted.trim();
    i.cursorNodeStart !== void 0 && (i.cursorNodeStart -= i.formatted.indexOf(D)), i.formatted = D + be(t8.endOfLine);
  }
  ...
  if (t8.cursorOffset >= 0) {
    ...
    let p = a.split("");
    p.splice(c, 0, Un);
    let l = f2.split(""), F2 = (0, Kn.diffArrays)(p, l), m = d;
    for (let E2 of F2) if (E2.removed) {
      if (E2.value.includes(Un)) break;
    } else m += E2.count;
...
async function vo(e, t8) {
  let { ast: r, text: n } = await De(e, t8), { rangeStart: o, rangeEnd: u } = Mn(n, t8, r), i = n.slice(o, u), s = Math.min(o, n.lastIndexOf(`
`, o) + 1), D = n.slice(s, o).match(/^\s*/)[0], a = Fe(D, t8.tabWidth), c = await qn(i, { ...t8, rangeStart: 0, rangeEnd: Number.POSITIVE_INFINITY, cursorOffset: t8.cursorOffset > o && t8.cursorOffset <= u ? t8.cursorOffset - o : -1, endOfLine: "lf" }, a), d = c.formatted.trimEnd(), { cursorOffset: f2 } = t8;
  f2 > u ? f2 += d.length - i.length : c.cursorOffset >= 0 && (f2 = c.cursorOffset + o);
  let p = n.slice(0, o) + d + n.slice(u);
  if (t8.endOfLine !== "lf") {
    let l = be(t8.endOfLine);
    f2 >= 0 && l === `\r
` && (f2 += _t(p.slice(0, f2), `
`)), p = ee(false, p, `
`, l);
...
function zn(e, t8) {
  ...
  return r = Jt(e, r, -1), n = Jt(e, n, 0), o = Jt(e, o, e.length), { ...t8, cursorOffset: r, rangeStart: n, rangeEnd: o };
}
function Jn(e, t8) {
  let { cursorOffset: r, rangeStart: n, rangeEnd: o, endOfLine: u } = zn(e, t8), i = e.charAt(0) === Hn;
  if (i && (e = e.slice(1), r--, n--, o--), u === "auto" && (u = hr(e)), e.includes("\r")) {
    let s = (D) => _t(e.slice(0, Math.max(D, 0)), `\r
`);
    r -= s(r), n -= s(n), o -= s(o), e = gr(e);
  }
  return { hasBOM: i, text: e, options: zn(e, { ...t8, cursorOffset: r, rangeStart: n, rangeEnd: o, endOfLine: u }) };
}
async function Gn(e, t8) {
  let r = await ft(t8);
  return !r.hasPragma || r.hasPragma(e);
}
async function Xt(e, t8) {
  let { hasBOM: r, text: n, options: o } = Jn(e, await re(t8));
  if (o.rangeStart >= o.rangeEnd && n !== "" || o.requirePragma && !await Gn(n, o)) return { formatted: e, cursorOffset: t8.cursorOffset, comments: [] };
  let u;
...
async function Xn(e, t8, r) {
  let { text: n, options: o } = Jn(e, await re(t8)), u = await De(n, o);
  return r && (r.preprocessForPrint && (u.ast = await Ht(u.ast, o)), r.massage && (u.ast = fn(u.ast, o))), u;
}
async function Zn(e, t8) {
  t8 = await re(t8);
  let r = await je(e, t8);
  return fe(r, t8);
}
async function Qn(e, t8) {
  let r = Pr(e), { formatted: n } = await Xt(r, { ...t8, parser: "__js_expression" });
  return n;
}
...
var Ee = Lo;
function Io(e, t8) {
  return t8 === false ? false : e.charAt(t8) === "/" && e.charAt(t8 + 1) === "/" ? mt(e, t8) : t8;
}
var Ce = Io;
function Ro(e, t8) {
  let r = null, n = t8;
...
function jo(e, t8) {
  let r = e.match(new RegExp(`(${Zt(t8)})+`, "g"));
...
var iu = Wo;
function Uo(e, t8, r) {
  let n = t8 === '"' ? "'" : '"', u = ee(false, e, /\\(.)|(["'])/gs, (i, s, D) => s === n ? s : D === t8 ? "\\" + D : D || (r && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/.test(s) ? s : "\\" + s));
  return t8 + u + t8;
}
var su = Uo;
function zo(e, t8, r) {
...
function Go(e, t8) {
  return arguments.length === 2 || typeof t8 == "number" ? Ve(e, t8) : zo(...arguments);
}
function Ko(e, t8, r) {
  return Ye(e, r(t8));
}
function Ho(e, t8) {
  return arguments.length === 2 || typeof t8 == "number" ? Ye(e, t8) : Ko(...arguments);
}
function qo(e, t8, r) {
  return Ct(e, r(t8));
}
function Jo(e, t8) {
  return arguments.length === 2 || typeof t8 == "number" ? Ct(e, t8) : qo(...arguments);
}
var er = {};
We(er, { builders: () => Xo, printer: () => Zo, utils: () => Qo });
var Xo = { join: ke, line: Ke, softline: Er, hardline: G, literalline: He, group: At, conditionalGroup: fr, fill: Ge, lineSuffix: Be, lineSuffixBoundary: dr, cursor: xe, breakParent: le, ifBreak: Fr, trim: mr, indent: ie, indentIfBreak: pr, align: oe, addAlignmentToDoc: qe, markAsRoot: cr, dedentToRoot: ar, dedent: lr, hardlineWithoutBreakParent: _e, literallineWithoutBreakParent: Bt, label: Cr, concat: (e) => e };
var Zo = { printDocToString: fe };
var Qo = { willBreak: wr, traverseDoc: Ae, findInDoc: Je, mapDoc: Ne, removeLines: Nr, stripTrailingHardline: Xe, replaceEndOfLine: Tr, canBreak: Sr };
var Du = "3.1.1";
function ae(e, t8 = 1) {
  return async (...r) => {
    var _a2, _b;
    let n = (_a2 = r[t8]) != null ? _a2 : {}, o = (_b = n.plugins) != null ? _b : [];
...
async function ei(e, t8) {
  return await cu(e, t8) === e;
}
var ti = ae(et, 0);
var ri = { parse: ae(Xn), formatAST: ae(Zn), formatDoc: ae(Qn), printToDoc: ae(eu), printDocToString: ae(tu) };
...
var Qr2 = (t8, e, r, n) => (jr(t8, e, "write to private field"), n ? n.call(t8, r) : e.set(t8, r), r);
var Ur2 = {};
Yr(Ur2, { languages: () => zs, options: () => Ys, parsers: () => Hr2, printers: () => To2 });
var Qs = (t8, e, r, n) => {
...
var le2 = "fill";
var ce2 = "if-break";
var pe2 = "indent-if-break";
var ke2 = "line-suffix";
var Be2 = "line-suffix-boundary";
var G2 = "line";
var Le2 = "label";
var he2 = "break-parent";
var ft2 = /* @__PURE__ */ new Set([Te2, oe2, ue2, xe2, ee2, le2, ce2, pe2, ke2, Be2, G2, Le2, he2]);
function Xs(t8) {
  if (typeof t8 == "string") return we2;
  if (Array.isArray(t8)) return be2;
  if (!t8) return;
  let { type: e } = t8;
  if (ft2.has(e)) return e;
}
var Fe2 = Xs;
...
Expected it to be 'string' or 'object'.`;
  if (Fe2(t8)) throw new Error("doc is valid.");
  let r = Object.prototype.toString.call(t8);
  if (r !== "[object Object]") return `Unexpected doc '${r}'.`;
  let n = Js([...ft2].map((s) => `'${s}'`));
...
var dt2 = Xr2;
function R2(t8) {
  return te2(t8), { type: oe2, contents: t8 };
}
function Jr2(t8, e) {
  return te2(e), { type: ue2, contents: e, n: t8 };
}
function E(t8, e = {}) {
  return te2(t8), dt2(e.expandedStates, true), { type: ee2, id: e.id, contents: t8, break: !!e.shouldBreak, expandedStates: e.expandedStates };
}
function Zr2(t8) {
...
function gt(t8) {
  return dt2(t8), { type: le2, parts: t8 };
}
function fe2(t8, e = "", r = {}) {
  return te2(t8), e !== "" && te2(e), { type: ce2, breakContents: t8, flatContents: e, groupId: r.groupId };
}
function tn2(t8, e) {
  return te2(t8), { type: pe2, contents: t8, groupId: e.groupId, negate: e.negate };
}
var re2 = { type: he2 };
var ei2 = { type: G2, hard: true };
var ti2 = { type: G2, hard: true, literal: true };
var A2 = { type: G2 };
var b2 = { type: G2, soft: true };
var S2 = [ei2, re2];
var rn2 = [ti2, re2];
function Y2(t8, e) {
  te2(t8), dt2(e);
...
function ni(t8) {
  switch (Fe2(t8)) {
    ...
    case ee2:
      ...
      if (t8.contents.type === ee2 && t8.contents.id === t8.id && t8.contents.break === t8.break && t8.contents.expandedStates === t8.expandedStates) return t8.contents;
      break;
    case ue2:
    case oe2:
    case pe2:
    ...
    case be2: {
      ...
      for (let r of t8) {
        ...
        typeof n == "string" && typeof me2(false, e, -1) == "string" ? e[e.length - 1] += n : e.push(n), e.push(...s);
      }
...
function nn2(t8) {
  return Ct2(t8, (e) => ni(e));
}
function T2(t8, e = rn2) {
  return Ct2(t8, (r) => typeof r == "string" ? Y2(e, r.split(`
`)) : r);
}
var nr2 = class extends Error {
...
var an2 = '"';
function si(t8, e) {
  let r = e === true || e === St2 ? St2 : an2, n = r === St2 ? an2 : St2, s = 0, i = 0;
...
var ir2 = class {
  ...
  hasLeadingWhitespace(e) {
    return Q(this, O2).has(e.charAt(0));
  }
  hasTrailingWhitespace(e) {
    return Q(this, O2).has(me2(false, e, -1));
  }
  trimStart(e) {
    let r = this.getLeadingWhitespaceCount(e);
    return e.slice(r);
  ...
  split(e, r = false) {
    let n = `[${sr2([...Q(this, O2)].join(""))}]+`, s = new RegExp(r ? `(${n})` : n);
    return e.split(s);
  }
...
function ln2(t8, e) {
  var r;
  if (t8.type === "text" || t8.type === "comment" || Pe2(t8) || t8.type === "yaml" || t8.type === "toml") return null;
...
function pi(t8, e) {
  var _a2, _b;
  if (e) return (_b = (_a2 = t8.find(({ name: r }) => r.toLowerCase() === e)) != null ? _a2 : t8.find(({ aliases: r }) => r == null ? void 0 : r.includes(e))) != null ? _b : t8.find(({ extensions: r }) => r == null ? void 0 : r.includes(`.${e}`));
}
function hi(t8, e) {
  var _a2, _b, _c;
...
var de2 = fi;
var mi = (t8) => v2(false, t8, /^[\t\f\r ]*\n/g, "");
var ar2 = (t8) => mi(H2.trimEnd(t8));
var gn = (t8) => {
  let e = t8, r = H2.getLeadingWhitespace(e);
  r && (e = e.slice(r.length));
  let n = H2.getTrailingWhitespace(e);
  return n && (e = e.slice(0, -n.length)), { leadingWhitespace: r, trailingWhitespace: n, text: e };
};
function _t2(t8, e) {
  return !!(t8.type === "ieConditionalComment" && t8.lastChild && !t8.lastChild.isSelfClosing && !t8.lastChild.endSourceSpan || t8.type === "ieConditionalComment" && !t8.complete || ge(t8) && t8.children.some((r) => r.type !== "text" && r.type !== "interpolation") || Dt2(t8, e) && !V2(t8) && t8.type !== "interpolation");
}
function Ge2(t8) {
...
function Cn(t8) {
  return t8.children && !V2(t8);
}
function Sn2(t8) {
  return V2(t8) || t8.type === "interpolation" || or2(t8);
}
function or2(t8) {
  return kn2(t8).startsWith("pre");
}
function _n2(t8, e) {
  var s, i;
  let r = n();
  ...
  return r;
  function n() {
    return Pe2(t8) || t8.type === "angularControlFlowBlock" ? false : (t8.type === "text" || t8.type === "interpolation") && t8.prev && (t8.prev.type === "text" || t8.prev.type === "interpolation") ? true : !t8.parent || t8.parent.cssDisplay === "none" ? false : ge(t8.parent) ? true : !(!t8.prev && (t8.parent.type === "root" || ge(t8) && t8.parent || V2(t8.parent) || Ke2(t8.parent, e) || !Ai(t8.parent.cssDisplay)) || t8.prev && !yi(t8.prev.cssDisplay));
  }
}
function En(t8, e) {
  return Pe2(t8) || t8.type === "angularControlFlowBlock" ? false : (t8.type === "text" || t8.type === "interpolation") && t8.next && (t8.next.type === "text" || t8.next.type === "interpolation") ? true : !t8.parent || t8.parent.cssDisplay === "none" ? false : ge(t8.parent) ? true : !(!t8.next && (t8.parent.type === "root" || ge(t8) && t8.parent || V2(t8.parent) || Ke2(t8.parent, e) || !Di(t8.parent.cssDisplay)) || t8.next && !vi(t8.next.cssDisplay));
}
function An2(t8) {
  return wi(t8.cssDisplay) && !V2(t8);
}
function Ye2(t8) {
  return Pe2(t8) || t8.next && t8.sourceSpan.end && t8.sourceSpan.end.line + 1 < t8.next.sourceSpan.start.line;
}
function Dn2(t8) {
  return ur(t8) || t8.type === "element" && t8.children.length > 0 && (["body", "script", "style"].includes(t8.name) || t8.children.some((e) => Ci(e))) || t8.firstChild && t8.firstChild === t8.lastChild && t8.firstChild.type !== "text" && yn2(t8.firstChild) && (!t8.lastChild.isTrailingSpaceSensitive || wn2(t8.lastChild));
}
function ur(t8) {
...
function Et2(t8) {
  return bn2(t8) || t8.prev && gi(t8.prev) || vn2(t8);
}
function gi(t8) {
  return bn2(t8) || t8.type === "element" && t8.fullName === "br" || vn2(t8);
}
function vn2(t8) {
  return yn2(t8) && wn2(t8);
}
function yn2(t8) {
...
function At2(t8) {
  return t8.lastChild ? At2(t8.lastChild) : t8;
}
function Ci(t8) {
  var e;
...
function Si(t8, e) {
  ...
  return !i && !s ? "babel" : (_a2 = Ne2(e, { language: i })) != null ? _a2 : Tn2(s);
}
function _i(t8, e) {
  var _a2;
  if (!Dt2(t8, e)) return;
  ...
  let { type: n, lang: s } = r;
  return (_a2 = Ne2(e, { language: s })) != null ? _a2 : Tn2(n);
}
function Ei(t8, e) {
...
function lr2(t8, e) {
  var _a2, _b;
  return (_b = (_a2 = Si(t8, e)) != null ? _a2 : Ei(t8, e)) != null ? _b : _i(t8, e);
}
function je2(t8) {
  return t8 === "block" || t8 === "list-item" || t8.startsWith("table");
}
function Ai(t8) {
  return !je2(t8) && t8 !== "inline-block";
}
function Di(t8) {
  return !je2(t8) && t8 !== "inline-block";
}
...
function xn2(t8, e) {
  ...
  switch (e.htmlWhitespaceSensitivity) {
    ...
    case "ignore":
      return "block";
    default:
      return t8.type === "element" && (!t8.namespace || r || de2(t8)) && fn2[t8.name] || hn;
  }
}
function kn2(t8) {
  return t8.type === "element" && (!t8.namespace || de2(t8)) && dn[t8.name] || mn;
}
function Ti(t8) {
...
`)) {
    ...
    let n = H2.getLeadingWhitespaceCount(r);
    if (n === 0) return 0;
    r.length !== n && n < e && (e = n);
  }
  return e === Number.POSITIVE_INFINITY ? 0 : e;
}
function cr2(t8, e = Ti(t8)) {
  return e === 0 ? t8 : t8.split(`
`).map((r) => r.slice(e)).join(`
`);
}
function pr2(t8) {
  return v2(false, v2(false, t8, "&apos;", "'"), "&quot;", '"');
}
function L2(t8) {
  return pr2(t8.value);
}
...
function Ke2(t8, e) {
  return Ce2(t8, e) && !xi.has(t8.fullName);
}
function Ce2(t8, e) {
  return e.parser === "vue" && t8.type === "element" && t8.parent.type === "root" && t8.fullName.toLowerCase() !== "html";
}
function Dt2(t8, e) {
  return Ce2(t8, e) && (Ke2(t8, e) || t8.attrMap.lang && t8.attrMap.lang !== "html");
}
function Bn2(t8) {
  let e = t8.fullName;
...
function vt2(t8, e = t8.value) {
  return t8.parent.isWhitespaceSensitive ? t8.parent.isIndentationSensitive ? T2(e) : T2(cr2(ar2(e)), S2) : Y2(A2, H2.split(e));
}
function yt2(t8, e) {
  return Ce2(t8, e) && t8.name === "script";
}
function wt2(t8) {
...
function Fn2(t8) {
  return t8 >= 97 && t8 <= 102 || t8 >= 65 && t8 <= 70 || hr2(t8);
}
function fr2(t8) {
  return t8 === 10 || t8 === 13;
}
...
var Re2 = class {
  constructor(e, r, n = Tt2.ERROR) {
    this.span = e, this.msg = r, this.level = n;
  }
  contextualMessage() {
    let e = this.span.start.getContext(100, 3);
    return e ? `${this.msg} ("${e.before}[${Tt2[this.level]} ->]${e.after}")` : this.msg;
  }
  toString() {
...
function Ri(t8) {
  let e = (r) => {
    var n, s;
    return r.type === "element" && r.attrs.length === 0 && r.children.length === 1 && r.firstChild.type === "text" && !H2.hasWhitespaceCharacter(r.children[0].value) && !r.firstChild.hasLeadingSpaces && !r.firstChild.hasTrailingSpaces && r.isLeadingSpaceSensitive && !r.hasLeadingSpaces && r.isTrailingSpaceSensitive && !r.hasTrailingSpaces && ((n = r.prev) == null ? void 0 : n.type) === "text" && ((s = r.next) == null ? void 0 : s.type) === "text";
  };
  t8.walk((r) => {
    if (r.children) for (let n = 0; n < r.children.length; n++) {
      let s = r.children[n];
...
function Oi(t8) {
  t8.walk((e) => {
    ...
    if (e.children.length === 0 || e.children.length === 1 && e.children[0].type === "text" && H2.trim(e.children[0].value).length === 0) {
...
function Vi(t8, e) {
  t8.walk((r) => {
    ...
    if (n) {
      if (n.length === 0) {
        r.isDanglingSpaceSensitive = An2(r);
        return;
      }
      for (let s of n) s.isLeadingSpaceSensitive = _n2(s, e), s.isTrailingSpaceSensitive = En(s, e);
...
async function Ui(t8, e) {
  if (t8.lang === "yaml") {
    ...
    return en2([t8.startDelimiter, S2, n, n ? S2 : "", t8.endDelimiter]);
  }
}
var On2 = Ui;
var Mn2 = new Proxy(() => {
...
var xt2 = Wi;
function Qe2(t8, e) {
  return [t8.isSelfClosing ? "" : zi(t8, e), Xe2(t8, e)];
}
function zi(t8, e) {
  return t8.lastChild && Ae2(t8.lastChild) ? "" : [Gi(t8, e), kt2(t8, e)];
}
function Xe2(t8, e) {
  return (t8.next ? j2(t8.next) : Ee2(t8.parent)) ? "" : [_e2(t8, e), U2(t8, e)];
}
function Gi(t8, e) {
  return Ee2(t8) ? _e2(t8.lastChild, e) : "";
}
function U2(t8, e) {
  return Ae2(t8) ? kt2(t8.parent, e) : Je2(t8) ? Bt2(t8.next) : "";
}
function kt2(t8, e) {
  if (gr2(!t8.isSelfClosing), qn2(t8, e)) return "";
  switch (t8.type) {
    case "ieConditionalComment":
      return "<!";
    case "element":
...
function qn2(t8, e) {
  return !t8.isSelfClosing && !t8.endSourceSpan && (Ge2(t8) || _t2(t8.parent, e));
}
function j2(t8) {
  return t8.prev && t8.prev.type !== "docType" && t8.type !== "angularControlFlowBlock" && !N2(t8.prev) && t8.isLeadingSpaceSensitive && !t8.hasLeadingSpaces;
}
function Ee2(t8) {
  var e;
  return ((e = t8.lastChild) == null ? void 0 : e.isTrailingSpaceSensitive) && !t8.lastChild.hasTrailingSpaces && !N2(At2(t8.lastChild)) && !ge(t8);
}
function Ae2(t8) {
  return !t8.next && !t8.hasTrailingSpaces && t8.isTrailingSpaceSensitive && N2(At2(t8));
}
function Je2(t8) {
  return t8.next && !N2(t8.next) && N2(t8) && t8.isTrailingSpaceSensitive && !t8.hasTrailingSpaces;
}
function Yi(t8) {
...
function ji(t8, e, r) {
  var m;
  let { node: n } = t8;
  if (!xt2(n.attrs)) return n.isSelfClosing ? " " : "";
  let s = ((m = n.prev) == null ? void 0 : m.type) === "comment" && Yi(n.prev.value), i = typeof s == "boolean" ? () => s : Array.isArray(s) ? (d) => s.includes(d.rawName) : () => false, a = t8.map(({ node: d }) => i(d) ? T2(e.originalText.slice(se2(d), ie2(d))) : r(), "attrs"), o = n.type === "element" && n.fullName === "script" && n.attrs.length === 1 && n.attrs[0].fullName === "src" && n.children.length === 0, p = e.singleAttributePerLine && n.attrs.length > 1 && !Ce2(n, e) ? S2 : A2, l = [R2([o ? " " : A2, Y2(p, a)])];
  return n.firstChild && Ze2(n.firstChild) || n.isSelfClosing && Ee2(n.parent) || o ? l.push(n.isSelfClosing ? " " : "") : l.push(e.bracketSameLine ? n.isSelfClosing ? " " : "" : n.isSelfClosing ? A2 : b2), l;
}
function Ki(t8) {
  return t8.firstChild && Ze2(t8.firstChild) ? "" : Lt2(t8);
}
function et2(t8, e, r) {
  let { node: n } = t8;
  return [tt2(n, e), ji(t8, e, r), n.isSelfClosing ? "" : Ki(n)];
}
function tt2(t8, e) {
  return t8.prev && Je2(t8.prev) ? "" : [W2(t8, e), Bt2(t8)];
}
function W2(t8, e) {
  return Ze2(t8) ? Lt2(t8.parent) : j2(t8) ? _e2(t8.prev, e) : "";
}
function Bt2(t8) {
  switch (t8.type) {
    case "ieConditionalComment":
...
function Qi(t8, e) {
  let { root: r } = t8;
  return Cr2.has(r) || Cr2.set(r, r.children.some((n) => yt2(n, e) && ["ts", "typescript"].includes(n.attrMap.lang))), Cr2.get(r);
}
var $e2 = Qi;
function Xi(t8, e) {
  if (!t8.endSourceSpan) return "";
  let r = t8.startSourceSpan.end.offset;
  t8.firstChild && Ze2(t8.firstChild) && (r -= Lt2(t8).length);
  let n = t8.endSourceSpan.start.offset;
  return t8.lastChild && Ae2(t8.lastChild) ? n += kt2(t8, e).length : Ee2(t8) && (n -= _e2(t8.lastChild, e).length), e.originalText.slice(r, n);
}
var Ft = Xi;
function Hn2(t8) {
  return t8 === "	" || t8 === `
...
function na(t8) {
  ...
  function m() {
    for (p(Ji), s = "", i = "in descriptor"; ; ) {
      if (a = t8.charAt(o), i === "in descriptor") if (Hn2(a)) s && (n.push(s), s = "", i = "after descriptor");
      else if (a === ",") {
        o += 1, s && n.push(s), d();
        return;
      ...
      else if (i === "after descriptor" && !Hn2(a)) if (a === "") {
        d();
        return;
  ...
  function d() {
    ...
    for (B = 0; B < n.length; B++) g = n[B], y2 = g[g.length - 1], $ = g.substring(0, g.length - 1), w2 = parseInt($, 10), q2 = parseFloat($), Vn2.test($) && y2 === "w" ? ((_2 || D) && (C = true), w2 === 0 ? C = true : _2 = w2) : ra.test($) && y2 === "x" ? ((_2 || D || P2) && (C = true), q2 < 0 ? C = true : D = q2) : Vn2.test($) && y2 === "h" ? ((P2 || D) && (C = true), w2 === 0 ? C = true : P2 = w2) : C = true;
...
var Un2 = na;
function De2(t8, e = true) {
  return [R2([b2, t8]), e ? b2 : ""];
}
function K2(t8, e) {
...
function sa(t8) {
  if (t8.node.fullName === "srcset" && (t8.parent.fullName === "img" || t8.parent.fullName === "source")) return () => aa(L2(t8.node));
}
var Wn2 = { width: "w", height: "h", density: "x" };
var ia = Object.keys(Wn2);
function aa(t8) {
  let e = Un2(t8), r = ia.filter((l) => e.some((m) => Object.prototype.hasOwnProperty.call(m, l)));
...
var zn2 = sa;
function oa(t8, e) {
  let { node: r } = t8, n = L2(r);
  if (r.fullName === "class" && !e.parentParser && !n.includes("{{")) return () => n.trim().split(/\s+/).join(" ");
}
var Gn2 = oa;
function Yn2(t8, e) {
  let { node: r } = t8, n = L2(t8.node).trim();
  if (r.fullName === "style" && !e.parentParser && !n.includes("{{")) return async (s) => De2(await s(n, { parser: "css", __isHTMLStyleAttribute: true }));
}
async function jn2(t8, e, r, n) {
  let s = L2(r.node), { left: i, operator: a, right: o } = ua(s), u = $e2(r, n);
...
function ua(t8) {
  ...
  let a = v2(false, s[1].trim(), n, ""), o = a.match(r);
...
function Kn2(t8, e, r) {
  let { node: n } = r, s = L2(n);
  return x2(`type T<${s}> = any`, t8, { parser: "babel-ts", __isEmbeddedTypescriptGenericParameters: true }, K2);
}
function Qn2(t8, e, { parseWithTs: r }) {
...
function la(t8, e) {
  ...
  if (n === "v-for") return jn2;
  if (n === "generic" && yt2(r.parent, e)) return Kn2;
  let s = L2(r), i = $e2(t8, e);
  if (Bn2(r) || Ln2(r, e)) return (a) => Qn2(s, a, { parseWithTs: i });
...
function ca(t8, e, { parseWithTs: r }) {
  return Xn2(t8) ? Jn2(t8, e, { parseWithTs: r }) : x2(t8, e, { parser: r ? "__vue_ts_event_binding" : "__vue_event_binding" }, K2);
}
function pa(t8, e, { parseWithTs: r }) {
  return x2(t8, e, { parser: r ? "__vue_ts_expression" : "__vue_expression" }, K2);
}
function Jn2(t8, e, { parseWithTs: r }) {
  return x2(t8, e, { parser: r ? "__ts_expression" : "__js_expression" }, K2);
}
var Zn2 = la;
var Sr2 = /{{(.+?)}}/s;
async function es(t8, e) {
  let r = [];
  for (let [n, s] of t8.split(Sr2).entries()) if (n % 2 === 0) r.push(T2(s));
  else try {
    r.push(E(["{{", R2([A2, await x2(s, e, { parser: "__ng_interpolation", __isInHtmlInterpolation: true, trailingComma: "none" })]), A2, "}}"]));
  } catch (e2) {
    r.push("{{", T2(s), "}}");
  }
  return r;
}
function _r2({ parser: t8 }) {
  return (e, r, n) => x2(L2(n.node), e, { parser: t8, trailingComma: "none" }, K2);
}
var ha = _r2({ parser: "__ng_action" });
var fa = _r2({ parser: "__ng_binding" });
var ma = _r2({ parser: "__ng_directive" });
function da(t8, e) {
  ...
  let s = L2(r);
  if (/^i18n(?:-.+)?$/.test(n)) return () => De2(gt(vt2(r, s.trim())), !s.includes("@@"));
  if (Sr2.test(s)) return (i) => es(s, i);
}
var ts = da;
function ga(t8, e) {
  let { node: r } = t8;
  if (r.value) {
    ...
    for (let n of [zn2, Yn2, Gn2, Zn2, ts]) {
      let s = n(t8, e);
      if (s) return Ca(s);
    }
  }
...
function Ca(t8) {
  return async (e, r, n, s) => {
    ...
    if (i) return i = Ct2(i, (a) => typeof a == "string" ? v2(false, a, '"', "&quot;") : a), [n.node.rawName, '="', E(i), '"'];
  };
}
var rs = ga;
function Sa(t8, e, r, n) {
  let { node: s } = r, i = n.originalText.slice(s.sourceSpan.start.offset, s.sourceSpan.end.offset);
  return /^\s*$/.test(i) ? "" : x2(i, t8, { parser: "__ng_directive", __isInHtmlAttribute: false, trailingComma: "none" }, K2);
}
var ns = Sa;
...
function Ea(t8, e) {
  ...
  switch (r.type) {
    case "element":
      if (V2(r) || r.type === "interpolation") return;
      if (!r.isSelfClosing && Dt2(r, e)) {
        let n = lr2(r, e);
        return n ? async (s, i) => {
          let a = Ft(r, e), o = /^\s*$/.test(a), u = "";
          return o || (u = await s(ar2(a), { parser: n, __embeddedInHtml: true }), o = u === ""), [W2(r, e), E(et2(t8, e, i)), o ? "" : S2, u, o ? "" : S2, Qe2(r, e), U2(r, e)];
        } : void 0;
      }
      break;
    case "text":
      if (V2(r.parent)) {
        ...
        if (n) return async (s) => {
          ...
          return [re2, W2(r, e), await s(i, a, { stripTrailingHardline: true }), U2(r, e)];
        };
      } else if (r.parent.type === "interpolation") return async (n) => {
        let s = { __isInHtmlInterpolation: true, __embeddedInHtml: true };
        return e.parser === "angular" ? (s.parser = "__ng_interpolation", s.trailingComma = "none") : e.parser === "vue" ? s.parser = $e2(t8, e) ? "__vue_ts_expression" : "__vue_expression" : s.parser = "__js_expression", [R2([A2, await n(r.value, s)]), r.parent.next && j2(r.parent.next) ? " " : A2];
      };
      break;
    case "attribute":
      return rs(t8, e);
...
function rt2(t8, e, r) {
  let n = t8.node;
  return Ge2(n) ? [W2(n, e), T2(e.originalText.slice(se2(n) + (n.prev && Je2(n.prev) ? Bt2(n).length : 0), ie2(n) - (n.next && j2(n.next) ? _e2(n, e).length : 0))), U2(n, e)] : r();
}
function Pt2(t8, e) {
  return N2(t8) && N2(e) ? t8.isTrailingSpaceSensitive ? t8.hasTrailingSpaces ? Et2(e) ? S2 : A2 : "" : Et2(e) ? S2 : b2 : Je2(t8) && (Ge2(e) || e.firstChild || e.isSelfClosing || e.type === "element" && e.attrs.length > 0) || t8.type === "element" && t8.isSelfClosing && j2(e) ? "" : !e.isLeadingSpaceSensitive || Et2(e) || j2(e) && t8.lastChild && Ae2(t8.lastChild) && t8.lastChild.lastChild && Ae2(t8.lastChild.lastChild) ? S2 : e.hasLeadingSpaces ? A2 : b2;
}
function Oe2(t8, e, r) {
  let { node: n } = t8;
  if (ur(n)) return [re2, ...t8.map((i) => {
    let a = i.node, o = a.prev ? Pt2(a.prev, a) : "";
    return [o ? [o, Ye2(a.prev) ? S2 : ""] : "", rt2(i, e, r)];
  }, "children")];
  ...
  return t8.map((i, a) => {
    ...
    if (N2(o)) {
      if (o.prev && N2(o.prev)) {
        let _2 = Pt2(o.prev, o);
        if (_2) return Ye2(o.prev) ? [S2, S2, rt2(i, e, r)] : [_2, rt2(i, e, r)];
      }
      return rt2(i, e, r);
    }
    let u = [], p = [], l = [], m = [], d = o.prev ? Pt2(o.prev, o) : "", C = o.next ? Pt2(o, o.next) : "";
    return d && (Ye2(o.prev) ? u.push(S2, S2) : d === S2 ? u.push(S2) : N2(o.prev) ? p.push(d) : p.push(fe2("", b2, { groupId: s[a - 1] }))), C && (Ye2(o) ? N2(o.next) && m.push(S2, S2) : C === S2 ? N2(o.next) && m.push(S2) : l.push(C)), [...u, E([...p, E([rt2(i, e, r), ...l], { id: s[a] })]), ...m];
  }, "children");
}
function is(t8, e, r) {
  let { node: n } = t8;
  if (_t2(n, e)) return [W2(n, e), E(et2(t8, e, r)), T2(Ft(n, e)), ...Qe2(n, e), U2(n, e)];
  let s = n.children.length === 1 && n.firstChild.type === "interpolation" && n.firstChild.isLeadingSpaceSensitive && !n.firstChild.hasLeadingSpaces && n.lastChild.isTrailingSpaceSensitive && !n.lastChild.hasTrailingSpaces, i = Symbol("element-attr-group-id"), a = (l) => E([E(et2(t8, e, r), { id: i }), l, Qe2(n, e)]), o = (l) => s ? tn2(l, { groupId: i }) : (V2(n) || Ke2(n, e)) && n.parent.type === "root" && e.parser === "vue" && !e.vueIndentScriptAndStyle ? l : R2(l), u = () => s ? fe2(b2, "", { groupId: i }) : n.firstChild.hasLeadingSpaces && n.firstChild.isLeadingSpaceSensitive ? A2 : n.firstChild.type === "text" && n.isWhitespaceSensitive && n.isIndentationSensitive ? Zr2(b2) : b2, p = () => (n.next ? j2(n.next) : Ee2(n.parent)) ? n.lastChild.hasTrailingSpaces && n.lastChild.isTrailingSpaceSensitive ? " " : "" : s ? fe2(b2, "", { groupId: i }) : n.lastChild.hasTrailingSpaces && n.lastChild.isTrailingSpaceSensitive ? A2 : (n.lastChild.type === "comment" || n.lastChild.type === "text" && n.isWhitespaceSensitive && n.isIndentationSensitive) && new RegExp(`\\n[\\t ]{${e.tabWidth * (t8.ancestors.length - 1)}}$`).test(n.lastChild.value) ? "" : b2;
  return n.children.length === 0 ? a(n.hasDanglingSpaces && n.isDanglingSpaceSensitive ? A2 : "") : a([Dn2(n) ? re2 : "", o([u(), Oe2(t8, e, r)]), p()]);
}
...
function os(t8, e, r) {
  ...
  let i = us(n);
  return n.children.length > 0 ? (n.firstChild.hasLeadingSpaces = true, n.lastChild.hasTrailingSpaces = true, s.push(R2([S2, Oe2(t8, e, r)])), i && s.push(S2, "}")) : i && s.push("}"), E(s, { shouldBreak: true });
}
function us(t8) {
  var e, r;
...
function ls(t8, e, r) {
  return [R2([b2, Y2([";", A2], t8.map(r, "children"))]), b2];
}
var nt2 = null;
function st2(t8) {
...
function ba(t8, e, r) {
  ...
  switch (n.type) {
    case "front-matter":
      return T2(n.raw);
    case "root":
      return e.__onHtmlRoot && e.__onHtmlRoot(n), [E(Oe2(t8, e, r)), S2];
    case "element":
    case "ieConditionalComment":
      return is(t8, e, r);
    ...
    case "angularControlFlowBlockParameter":
      return H2.trim(n.expression);
    case "ieConditionalStartComment":
    case "ieConditionalEndComment":
      return [tt2(n), Xe2(n)];
    case "interpolation":
      return [tt2(n, e), ...t8.map(r, "children"), Xe2(n, e)];
    case "text": {
      if (n.parent.type === "interpolation") {
        let i = /\n[^\S\n]*$/, a = i.test(n.value), o = a ? n.value.replace(i, "") : n.value;
        return [T2(o), a ? S2 : ""];
      }
      let s = nn2([W2(n, e), ...vt2(n), U2(n, e)]);
      return Array.isArray(s) ? gt(s) : s;
    }
    case "docType":
      return [E([tt2(n, e), " ", v2(false, n.value.replace(/^html\b/i, "html"), /\s+/g, " ")]), Xe2(n, e)];
    case "comment":
      return [W2(n, e), T2(e.originalText.slice(se2(n), ie2(n))), U2(n, e)];
    case "attribute": {
      if (n.value === null) return n.rawName;
      let s = pr2(n.value), i = on2(s, '"');
      return [n.rawName, "=", i, T2(i === '"' ? v2(false, s, '"', "&quot;") : v2(false, s, "'", "&apos;")), i];
    }
    case "cdata":
    default:
      throw new sn2(n, "HTML");
  }
}
var Ta = { preprocess: In2, print: ba, insertPragma: $n2, massageAstNode: cn2, embed: ss, getVisitorKeys: hs };
var fs = Ta;
var Hr2 = {};
Yr(Hr2, { angular: () => vo2, html: () => Do, lwc: () => wo2, vue: () => yo2 });
var Kc = new RegExp(`(\\:not\\()|(([\\.\\#]?)[-\\w]+)|(?:\\[([-.\\w*\\\\$]+)(?:=(["']?)([^\\]"']*)\\5)?\\])|(\\))|(\\s*,\\s*)`, "g");
var ms;
(function(t8) {
...
var Ar2 = { name: "custom-elements" };
var Dr2 = { name: "no-errors-schema" };
var X2;
(function(t8) {
...
function vr2(t8) {
  return it2(t8)[1] === "ng-container";
}
function yr2(t8) {
  return it2(t8)[1] === "ng-content";
}
function Me2(t8) {
  return t8 === null ? null : it2(t8)[0];
}
function qe2(t8, e) {
  return t8 ? `:${t8}:${e}` : e;
}
var It2;
function wr2() {
  return It2 || (It2 = {}, Nt2(X2.HTML, ["iframe|srcdoc", "*|innerHTML", "*|outerHTML"]), Nt2(X2.STYLE, ["*|style"]), Nt2(X2.URL, ["*|formAction", "area|href", "area|ping", "audio|src", "a|href", "a|ping", "blockquote|cite", "body|background", "del|cite", "form|action", "img|src", "input|src", "ins|cite", "q|cite", "source|src", "track|src", "video|poster", "video|src"]), Nt2(X2.RESOURCE_URL, ["applet|code", "applet|codebase", "base|href", "embed|src", "frame|src", "head|profile", "html|manifest", "iframe|src", "link|href", "media|src", "object|codebase", "object|data", "script|src"])), It2;
}
function Nt2(t8, e) {
  for (let r of e) It2[r.toLowerCase()] = t8;
}
var Rt2 = class {
};
var xa = "boolean";
...
var $t2 = class extends Rt2 {
  ...
  hasProperty(e, r, n) {
    if (n.some((i) => i.name === Dr2.name)) return true;
    if (e.indexOf("-") > -1) {
      if (vr2(e) || yr2(e)) return false;
      if (n.some((i) => i.name === Ar2.name)) return true;
    }
    return (this._schema.get(e.toLowerCase()) || this._schema.get("unknown")).has(r);
  }
  hasElement(e, r) {
    return r.some((n) => n.name === Dr2.name) || e.indexOf("-") > -1 && (vr2(e) || yr2(e) || r.some((n) => n.name === Ar2.name)) ? true : this._schema.has(e.toLowerCase());
  }
  securityContext(e, r, n) {
    n && (r = this.getMappedPropName(r)), e = e.toLowerCase(), r = r.toLowerCase();
    let s = wr2()[e + "|" + r];
    return s || (s = wr2()["*|" + r], s || X2.NONE);
  }
  getMappedPropName(e) {
    var _a2;
    return (_a2 = Cs.get(e)) != null ? _a2 : e;
  }
...
If '${e}' is a directive input, make sure the directive is imported by the current module.` } : { error: false };
  ...
  allKnownAttributesOfElement(e) {
    ...
    return Array.from(r.keys()).map((n) => {
      var _a2;
      return (_a2 = Pa.get(n)) != null ? _a2 : n;
    });
  }
...
var br2 = class t2 {
  static fromArray(e) {
    return e ? (_s("interpolation", e), new t2(e[0], e[1])) : Tr2;
  }
  constructor(e, r) {
...
function Ps(t8, e, r, n = {}) {
  let s = new Pr2(new Se2(t8, e), r, n);
  return s.tokenize(), new Fr2(lo2(s.tokens), s.errors, s.nonNormalizedIcuExpressions);
}
var ro2 = /\r\n?/g;
function Ue2(t8) {
...
var Pr2 = class {
  ...
  _processCarriageReturns(e) {
    return this._preserveLineEndings ? e : e.replace(ro2, `
`);
  }
  tokenize() {
  ...
  _getBlockName() {
    ...
    return this._attemptCharCodeUntilFn((n) => wt2(n) ? !e : xs(n) ? (e = true, false) : true), this._cursor.getChars(r).trim();
  }
  _consumeBlockStart(e) {
    this._beginToken(25, e);
    let r = this._endToken([this._getBlockName()]);
    if (this._cursor.peek() === 40) if (this._cursor.advance(), this._consumeBlockParameters(), this._attemptCharCodeUntilFn(k2), this._attemptCharCode(41)) this._attemptCharCodeUntilFn(k2);
    else {
      r.type = 29;
      return;
    }
  ...
  _endToken(e, r) {
    if (this._currentTokenStart === null) throw new ct2("Programming error - attempted to end a token when there was no start to the token", this._currentTokenType, this._cursor.getSpan(r));
    if (this._currentTokenType === null) throw new ct2("Programming error - attempted to end a token which has no token type", null, this._cursor.getSpan(this._currentTokenStart));
  ...
  _createError(e, r) {
    ...
    let n = new ct2(e, this._currentTokenType, r);
    return this._currentTokenStart = null, this._currentTokenType = null, new pt2(n);
  }
  handleError(e) {
    if (e instanceof ht2 && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))), e instanceof pt2) this.errors.push(e.error);
    else throw e;
  }
  _attemptCharCode(e) {
  ...
  _attemptCharCodeCaseInsensitive(e) {
    return uo2(this._cursor.peek(), e) ? (this._cursor.advance(), true) : false;
  }
  _requireCharCode(e) {
    let r = this._cursor.clone();
  ...
  _consumeEntity(e) {
    ...
    if (this._cursor.advance(), this._attemptCharCode(35)) {
      ...
      if (this._attemptCharCodeUntilFn(io), this._cursor.peek() != 59) {
        ...
        throw this._createError(no2(a, this._cursor.getChars(r)), this._cursor.getSpan());
      }
  ...
  _consumeTagOpen(e) {
    let r, n, s, i = [];
    try {
      if (!bt2(this._cursor.peek())) throw this._createError(Ue2(this._cursor.peek()), this._cursor.getSpan(e));
  ...
  _consumeTagClose(e) {
    if (this._beginToken(3, e), this._attemptCharCodeUntilFn(k2), this._allowHtmComponentClosingTags && this._attemptCharCode(47)) this._attemptCharCodeUntilFn(k2), this._requireCharCode(62), this._endToken([]);
    else {
  ...
  _consumeInterpolation(e, r, n) {
    ...
    for (; this._cursor.peek() !== 0 && (n === null || !n()); ) {
      ...
      this._cursor.advance(), p === 92 ? this._cursor.advance() : p === a ? a = null : !o && a === null && dr2(p) && (a = p);
    }
...
function bs(t8) {
  return wt2(t8) || t8 === 62 || t8 === 60 || t8 === 47 || t8 === 39 || t8 === 34 || t8 === 61 || t8 === 0;
}
function so(t8) {
  return (t8 < 97 || 122 < t8) && (t8 < 65 || 90 < t8) && (t8 < 48 || t8 > 57);
}
function io(t8) {
  return t8 === 59 || t8 === 0 || !Fn2(t8);
}
function ao(t8) {
  return t8 === 59 || t8 === 0 || !bt2(t8);
}
function oo(t8) {
  return t8 !== 125;
}
...
var Kt2 = class t3 {
  ...
  advanceState(e) {
    if (e.offset >= this.end) throw this.state = e, new ht2('Unexpected character "EOF"', this);
    let r = this.charAt(e.offset);
    r === 10 ? (e.line++, e.column = 0) : fr2(r) || e.column++, e.offset++, this.updatePeek(e);
  }
  updatePeek(e) {
    e.peek = e.offset >= this.end ? 0 : this.charAt(e.offset);
  }
  locationFromCursor(e) {
    return new ne2(e.file, e.state.offset, e.state.line, e.state.column);
  }
};
var Nr2 = class t4 extends Kt2 {
  constructor(e, r) {
  ...
  processEscapeSequence() {
    ...
    if (e() === 92) if (this.internalState = { ...this.state }, this.advanceState(this.internalState), e() === 110) this.state.peek = 10;
      ...
      for (; mr2(e()) && n < 3; ) s = this.clone(), r += String.fromCodePoint(e()), this.advanceState(this.internalState), n++;
      this.state.peek = parseInt(r, 8), this.internalState = s.internalState;
    } else fr2(this.internalState.peek) ? (this.advanceState(this.internalState), this.state = this.internalState) : this.state.peek = this.internalState.peek;
  }
  decodeHexDigits(e, r) {
    let n = this.input.slice(e.internalState.offset, e.internalState.offset + r), s = parseInt(n, 16);
    if (isNaN(s)) throw e.state = e.internalState, new ht2("Invalid hexadecimal escape sequence", e);
    return s;
  }
};
var ht2 = class {
...
var Qt2 = class {
  ...
  parse(e, r, n, s = false, i) {
    ...
    } : u, n), d = n && n.canSelfClose || false, C = n && n.allowHtmComponentClosingTags || false, _2 = new Or2(m.tokens, o, d, C, s);
    return _2.build(), new $r2(_2.rootNodes, m.errors.concat(_2.errors));
  }
};
var Or2 = class t6 {
  constructor(e, r, n, s, i) {
  ...
  build() {
    ...
    for (let e of this._containerStack) e instanceof J2 && this.errors.push(I2.create(e.name, e.sourceSpan, `Unclosed block "${e.name}"`));
  }
  _advance() {
    let e = this._peek;
  ...
  _consumeExpansion(e) {
    ...
    if (this._peek.type !== 24) {
      this.errors.push(I2.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '}'."));
      return;
    }
  ...
  _parseExpansionCase() {
    let e = this._advance();
    if (this._peek.type !== 22) return this.errors.push(I2.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '{'.")), null;
    ...
    return new Ht2(e.parts[0], i.rootNodes, a, e.sourceSpan, o);
  }
  _collectExpansionExpTokens(e) {
    ...
    for (; ; ) {
      ...
      } else return this.errors.push(I2.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
      if (this._peek.type === 24) if (Ns(n, 20)) n.pop();
      else return this.errors.push(I2.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
      if (this._peek.type === 30) return this.errors.push(I2.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
...
`) {
  ...
  _closeVoidElement() {
    ...
    e instanceof z2 && this.getTagDefinition(e.name).isVoid && this._containerStack.pop();
  }
  _consumeStartTag(e) {
    let [r, n] = e.parts, s = [];
    ...
    if (this._peek.type === 2) {
      ...
      this.canSelfClose || C.canSelfClose || Me2(i) !== null || C.isVoid || this.errors.push(I2.create(i, e.sourceSpan, `Only void, custom and foreign elements can be self closed "${e.parts[1]}"`));
    } else this._peek.type === 1 && (this._advance(), a = false);
    let o = this._peek.sourceSpan.fullStart, u = new f(e.sourceSpan.start, o, e.sourceSpan.fullStart), p = new f(e.sourceSpan.start, o, e.sourceSpan.fullStart), l = new f(e.sourceSpan.start.moveBy(1), e.sourceSpan.end), m = new z2(i, s, [], u, p, void 0, l), d = this._getContainer();
    this._pushContainer(m, d instanceof z2 && this.getTagDefinition(d.name).isClosedByChild(m.name)), a ? this._popContainer(i, z2, u) : e.type === 4 && (this._popContainer(i, z2, null), this.errors.push(I2.create(i, u, `Opening tag "${i}" not terminated.`)));
  }
  _pushContainer(e, r) {
  ...
  _consumeEndTag(e) {
    ...
    if (r && this.getTagDefinition(r).isVoid) this.errors.push(I2.create(r, e.sourceSpan, `Void elements do not have end tags "${e.parts[1]}"`));
    else if (!this._popContainer(r, z2, e.sourceSpan)) {
      ...
      this.errors.push(I2.create(r, e.sourceSpan, n));
    }
  }
  _popContainer(e, r, n) {
    let s = false;
    for (let i = this._containerStack.length - 1; i >= 0; i--) {
      ...
      (a instanceof J2 || a instanceof z2 && !this.getTagDefinition(a.name).closedByParent) && (s = true);
    }
    return false;
  }
  _consumeAttr(e) {
    ...
    let l = o && u && new f((_a2 = s == null ? void 0 : s.sourceSpan.start) != null ? _a2 : o.start, u, (_b = s == null ? void 0 : s.sourceSpan.fullStart) != null ? _b : o.fullStart);
  ...
  _consumeBlockOpen(e) {
    ...
    for (; this._peek.type === 28; ) {
      let o = this._advance();
      r.push(new ot2(o.parts[0], o.sourceSpan));
    }
    this._peek.type === 26 && this._advance();
    let n = this._peek.sourceSpan.fullStart, s = new f(e.sourceSpan.start, n, e.sourceSpan.fullStart), i = new f(e.sourceSpan.start, n, e.sourceSpan.fullStart), a = new J2(e.parts[0], r, [], s, i);
    this._pushContainer(a, false);
  }
  _consumeBlockClose(e) {
    this._popContainer(null, J2, e.sourceSpan) || this.errors.push(I2.create(null, e.sourceSpan, 'Unexpected closing block. The block may have been closed earlier. If you meant to write the } character, you should use the "&#125;" HTML entity instead.'));
  }
  _consumeIncompleteBlock(e) {
    ...
    let n = this._peek.sourceSpan.fullStart, s = new f(e.sourceSpan.start, n, e.sourceSpan.fullStart), i = new f(e.sourceSpan.start, n, e.sourceSpan.fullStart), a = new J2(e.parts[0], r, [], s, i);
    this._pushContainer(a, false), this._popContainer(null, J2, null), this.errors.push(I2.create(e.parts[0], s, `Incomplete block "${e.parts[0]}". If you meant to write the @ character, you should use the "&#64;" HTML entity instead.`));
  }
  _getContainer() {
    return this._containerStack.length > 0 ? this._containerStack[this._containerStack.length - 1] : null;
  }
  _getClosestParentElement() {
    for (let e = this._containerStack.length - 1; e > -1; e--) if (this._containerStack[e] instanceof z2) return this._containerStack[e];
    return null;
  }
  _addToParent(e) {
...
function Is(t8, e) {
  return Ve2[e] !== void 0 ? Ve2[e] || t8 : /^#x[a-f0-9]+$/i.test(e) ? String.fromCodePoint(parseInt(e.slice(2), 16)) : /^#\d+$/.test(e) ? String.fromCodePoint(parseInt(e.slice(1), 10)) : t8;
}
...
function qr2(t8, e = {}) {
  ...
  return co2().parse(t8, "angular-html-parser", { tokenizeExpansionForms: false, interpolationConfig: void 0, canSelfClose: r, allowHtmComponentClosingTags: n, tokenizeBlocks: a }, s, i);
}
var po2 = new RegExp("^(?<startDelimiter>-{3}|\\+{3})(?<language>[^\\n]*)\\n(?:|(?<value>.*?)\\n)(?<endDelimiter>\\k<startDelimiter>|\\.{3})[^\\S\\n]*(?:\\n|$)", "s");
function ho2(t8) {
  let e = t8.match(po2);
...
var Zt2 = { attrs: true, children: true };
...
var er2 = class t7 {
  ...
  setProperty(e, r) {
    if (this[e] !== r) {
      if (e in Zt2 && (r = r.map((n) => this.createChild(n))), !Ms.has(e)) {
        this[e] = r;
        return;
      }
  ...
  map(e) {
    ...
    for (let n in Zt2) {
      let s = this[n];
      if (s) {
        let i = mo2(s, (a) => a.map(e));
        r !== s && (r || (r = new t7({ parent: this.parent })), r.setProperty(n, i));
      }
    }
    if (r) for (let n in this) n in Zt2 || (r[n] = this[n]);
    return e(r || this);
  }
  walk(e) {
    for (let r in Zt2) {
...
var go2 = [{ regex: /^(\[if([^\]]*)]>)(.*?)<!\s*\[endif]$/s, parse: Co2 }, { regex: /^\[if([^\]]*)]><!$/, parse: So2 }, { regex: /^<!\s*\[endif]$/, parse: _o2 }];
function qs(t8, e) {
  if (t8.value) for (let { regex: r, parse: n } of go2) {
...
function Co2(t8, e, r) {
  ...
  return { type: "ieConditionalComment", complete: p, children: l, condition: v2(false, s.trim(), /\s+/g, " "), sourceSpan: t8.sourceSpan, startSourceSpan: new f(t8.sourceSpan.start, o), endSourceSpan: new f(u, t8.sourceSpan.end) };
}
function So2(t8, e, r) {
  let [, n] = r;
  return { type: "ieConditionalStartComment", condition: v2(false, n.trim(), /\s+/g, " "), sourceSpan: t8.sourceSpan };
}
function _o2(t8) {
...
function Eo2(t8) {
  if (t8.type === "block") {
    if (t8.name = v2(false, t8.name.toLowerCase(), /\s+/g, " ").trim(), t8.type = "angularControlFlowBlock", !xt2(t8.parameters)) {
      delete t8.parameters;
      return;
    }
    for (let e of t8.parameters) e.type = "angularControlFlowBlockParameter";
    t8.parameters = { type: "angularControlFlowBlockParameters", children: t8.parameters, sourceSpan: new f(t8.parameters[0].sourceSpan.start, me2(false, t8.parameters, -1).sourceSpan.end) };
  }
}
function Vs(t8, e, r) {
  let { name: n, canSelfClose: s = true, normalizeTagName: i = false, normalizeAttributeName: a = false, allowHtmComponentClosingTags: o = false, isTagNameCaseSensitive: u = false, shouldParseAsRawText: p } = e, { rootNodes: l, errors: m } = qr2(t8, { canSelfClose: s, allowHtmComponentClosingTags: o, isTagNameCaseSensitive: u, getTagContentType: p ? (...c) => p(...c) ? F.RAW_TEXT : void 0 : void 0, tokenizeAngularBlocks: n === "angular" ? true : void 0 });
  if (n === "vue") {
    if (l.some((w2) => w2.type === "docType" && w2.value === "html" || w2.type === "element" && w2.name.toLowerCase() === "html")) return Vs(t8, Ws, r);
    let g, y2 = () => g != null ? g : g = qr2(t8, { canSelfClose: s, allowHtmComponentClosingTags: o, isTagNameCaseSensitive: u }), $ = (w2) => {
      var _a2;
      return (_a2 = y2().rootNodes.find(({ startSourceSpan: q2 }) => q2 && q2.start.offset === w2.startSourceSpan.start.offset)) != null ? _a2 : w2;
    };
  ...
  let d = (c) => {
    ...
    if (c.type === "element" && (i && (!c.namespace || c.namespace === c.tagDefinition.implicitNamespacePrefix || de2(c)) && (c.name = _2(c.name, (g) => Os.has(g))), a)) for (let g of c.attrs) g.namespace || (g.name = _2(g.name, (y2) => Jt2.has(c.name) && (Jt2.get("*").has(y2) || Jt2.get(c.name).has(y2))));
  }, P2 = (c) => {
    ...
    if (c.type === "element") {
      ...
      !c.namespace || c.namespace === g.implicitNamespacePrefix || de2(c) ? c.tagDefinition = g : c.tagDefinition = He2("");
    }
  };
  return zt2(new class extends ut2 {
    visit(c) {
      C(c), B(c), D(c), P2(c);
    }
  }(), l), l;
...
function Us(t8, e, r = {}, n = true) {
  let { frontMatter: s, content: i } = n ? Rs(t8) : { frontMatter: null, content: t8 }, a = new Se2(t8, r.filepath), o = new ne2(a, 0, 0, 0), u = o.moveBy(t8.length), p = { type: "root", sourceSpan: new f(o, u), children: Vs(i, e, r) };
  if (s) {
    let d = new ne2(a, 0, 0, 0), C = d.moveBy(s.raw.length);
    s.sourceSpan = new f(d, C), p.children.unshift(s);
  }
  let l = new er2(p), m = (d, C) => {
    let { offset: _2 } = C, D = v2(false, t8.slice(0, _2), /[^\n\r]/g, " "), B = Us(D + d, e, r, false);
    B.sourceSpan = new f(C, me2(false, B.children, -1).sourceSpan.end);
    let c = B.children[0];
...
function tr2(t8) {
  return { parse: (e, r) => Us(e, t8, r), hasPragma: Rn2, astFormat: "html", locStart: se2, locEnd: ie2 };
}
var Ws = { name: "html", normalizeTagName: true, normalizeAttributeName: true, allowHtmComponentClosingTags: true };
var Do = tr2(Ws);
var vo2 = tr2({ name: "angular" });
var yo2 = tr2({ name: "vue", isTagNameCaseSensitive: true, shouldParseAsRawText(t8, e, r, n) {
  return t8.toLowerCase() !== "html" && !r && (t8 !== "template" || n.some(({ name: s, value: i }) => s === "lang" && i !== "html" && i !== "" && i !== void 0));
} });
var wo2 = tr2({ name: "lwc", canSelfClose: false });
...
var Vr2 = { bracketSpacing: { category: "Common", type: "boolean", default: true, description: "Print spaces between brackets.", oppositeDescription: "Do not print spaces between brackets." }, singleQuote: { category: "Common", type: "boolean", default: false, description: "Use single quotes instead of double quotes." }, proseWrap: { category: "Common", type: "choice", default: "preserve", description: "How to wrap prose.", choices: [{ value: "always", description: "Wrap prose if it exceeds the print width." }, { value: "never", description: "Do not wrap prose." }, { value: "preserve", description: "Wrap prose as-is." }] }, bracketSameLine: { category: "Common", type: "boolean", default: false, description: "Put > of opening tags on the last line instead of on a new line." }, singleAttributePerLine: { category: "Common", type: "boolean", default: false, description: "Enforce single attribute per line in HTML, Vue and JSX." } };
var Gs = "HTML";
var bo2 = { bracketSameLine: Vr2.bracketSameLine, htmlWhitespaceSensitivity: { category: Gs, type: "choice", default: "css", description: "How to handle whitespaces in HTML.", choices: [{ value: "css", description: "Respect the default value of CSS display property." }, { value: "strict", description: "Whitespaces are considered sensitive." }, { value: "ignore", description: "Whitespaces are considered insensitive." }] }, singleAttributePerLine: Vr2.singleAttributePerLine, vueIndentScriptAndStyle: { category: Gs, type: "boolean", default: false, description: "Indent script and style tags in Vue files." } };
var Ys = bo2;
var To2 = { html: fs };
var dh = Ur2;

// main.ts
var CopySource = class extends import_obsidian.Plugin {
  constructor() {
    super(...arguments);
    this.getSelectionHtml = () => {
      let html = "";
      if (typeof activeDocument.getSelection !== "undefined") {
        let sel = activeDocument.getSelection();
        if (sel == null ? void 0 : sel.rangeCount) {
          let container = activeDocument.createElement("div");
    ...
    this.prettifyCopy = async (src, f2) => {
      await cu(src, {
        filepath: f2.path,
        parser: "html",
        ...
        (pretty) => {
          ...
          new import_obsidian.Notice("Source copied to clipboard", 3e3);
        }
      );
    };
  }
    ...
    this.addCommand({
      ...
      checkCallback: (checking) => {
        ...
        if (file) {
          ...
          let isPreviewMode = (markdownView == null ? void 0 : markdownView.getMode()) === "preview";
          if (isPreviewMode) {
            if (!checking) {
  ...
  async copyStringToClipboard(text, topic = void 0) {
    navigator.clipboard.writeText(text).catch(function(error) {
      new import_obsidian.Notice("Failed to copy to clipboard: " + error, 0);
    });
  }
};

...
define([ 
  ...
  "dojo/on",
  "dojo/domReady!"
], function(reactiveUtils, declare, lang, query, on) {
  ...
  var CalciteMapsArcGISSupport = declare(null, {
    ...
    setPopupPanelSync: function(view) {
      ...
      reactiveUtils.watch(() => view.size, (size) => {
      ...
      reactiveUtils.watch(() => [popup.visible, popup.dockEnabled, popup.currentDockPosition], setPanelVisibility);
